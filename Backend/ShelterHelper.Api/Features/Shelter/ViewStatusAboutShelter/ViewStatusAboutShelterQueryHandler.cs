...
namespace ShelterHelper.Api.Features.Shelter.ViewStatusAboutShelter
{
    public class ViewStatusAboutShelterQueryHandler : IViewStatusAboutShelterQueryHandler
    {
        ...
        public async Task<ShelterWithBookingHistoryDto> HandleAsync(int shelterId, CancellationToken cancellationToken)
        {
            ...
            var shelterWithHistory = new ShelterWithBookingHistoryDto(shelter.Id, shelter.Name, shelter.Address, shelter.MapsLink, shelter.Capacity, shelter.MaximumDaysForRental, shelter.NumberOfUsers, shelter.Accessibility, shelter.Pets);
